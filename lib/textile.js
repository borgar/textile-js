...
*/
var singletons = __webpack_require__(2).singletons; // drop or add tab levels to JsonML tree
...
function parseDefList(src, options) {
  ...
  var parsePhrase = __webpack_require__(3).parsePhrase;
