...
|hooks|@[ function(jsonml :any[], param? :any) :any[], param? :any ]@|@[]@|Array of function (and optional initial parameter), applied in the order of the array to each JsonML node before rendering to HTML.
