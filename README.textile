...
* @breaks@ [default: [@true@]]
Used to enable/disable the default behavior of line-breaking single newlines within blocks.
* @autobacklink@ [default: [@false@]]
Turn this on to have footnotes automatically backlink to their references (otherwise enabled by syntax: @fn1^@).
